...
3. Choose Run if Windows asks for permission.
4. Follow the steps on the screen to finish the installation.
5. Create a folder where you want to keep your data.
...
- Use plain text files for best results.
- Organize folders by project or team.
- Keep your data in one central location.
...
- Processor: Modern processor with at least four cores.
- Storage: 2 GB of free space for the database index.
...
- Keep the computer plugged into power during the first scan.
- Avoid moving files while the indexer runs.
- Check the status bar at the bottom of the window to see progress.
...
1. Check your internet connection. An active connection is necessary for the AI features.
2. Confirm your API keys are valid. Ensure you have credits available in your Azure account.
3. Restart the application if the search results do not appear.
4. Rebuild the index if you add a large number of files at once. You find this option in the Settings menu under Data Management.

## 💬 Frequently Asked Questions

**Does Kairix work offline?**
The core search functionality works offline. Features that require AI analysis need an active internet connection to contact the service provider.

**Can I share my index?**
You can share the database file with team members, but ensure they have the same version of Kairix installed.

**Where does Kairix store data?**
The application creates a local folder in your Documents directory. You can move this folder to a different drive if you need more space.

**Is my data secure?**
Your files remain on your local storage. The AI agent only receives the specific text it needs to answer your current query.

**How do I update the software?**
Visit the download page periodically to check for newer versions. You can install a new version over the old one without losing your index.